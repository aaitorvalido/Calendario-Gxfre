...
export async function POST(request: Request) {
  try {
    ...
    // 2. === GUARDAR EN SUPABASE (Usando la llave maestra) ===
    // Forzamos el uso de la SECRET_KEY para saltarnos el RLS
    ...
    if (supabaseError) {
        ...
        // No bloqueamos el proceso aquí por si Resend sí funciona
    }
